...
def gen_passage_rep(args, model, tokenizer):
    ...
    print(args.gen_passage_rep_input)
    ...
    logger.info("  Wrriting to = %s", args.gen_passage_rep_output)
    ...
    for bid, batch in tqdm(enumerate(eval_dataloader), desc="Evaluating", total=len(eval_dataloader)):
        model.eval()
...
print(args.retrieve, args.gen_passage_rep)
