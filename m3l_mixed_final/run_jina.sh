#!/bin/bash
#SBATCH --job-name=rtp_1_jrdb
#SBATCH --output=m3l_mixed_jr_ret_dbert.out
#SBATCH --error=m3l_mixed_jr_ret_dbert.err
#SBATCH --mem=64g
...
D=/data/tir/projects/tir7/user_data/priyansk/m3l_mixed_jr_ret_dbert_lr
# D=/data/tir/projects/tir7/user_data/priyansk/m3l_mixed_jr_ret_dbert

D1=/data/tir/projects/tir7/user_data/priyansk/m3l_mixed_jr_ret
