...
class BertForOrconvqaGlobal(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # load the pretrained bert squad model
        self.bert = BertModel.from_pretrained('csarron/bert-base-uncased-squad-v1')
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None,
        ...
        modality_labels=modality_labels.reshape(-1, 1).expand(-1,num_blocks).view(-1)
