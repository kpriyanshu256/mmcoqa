...
#SBATCH --output=m3l_mixed_clip_ret_b2.out
#SBATCH --error=m3l_mixed_clip_ret_b2.err
#SBATCH --mem=64g
...
D=/data/tir/projects/tir7/user_data/priyansk/m3l_clip_retriever_dbert2
D1=/data/tir/projects/tir7/user_data/priyansk/m3l_clip_retriever
